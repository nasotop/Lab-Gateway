...
public class OrderTestController {
    ...
    public ResultDto<OrderTestDto> create(@RequestBody OrderTestDto dto) {
        return orderTestService.createOrderTest(dto);
    }

    @PostMapping("update-order-test/{id}")
    public ResultDto<OrderTestDto> update(@PathVariable Long id, @RequestBody OrderTestDto dto) {
