...
public class TestTypeController {
    ...
    public ResultDto<TestTypeDto> create(@Valid @RequestBody TestTypeDto dto) {
        return service.createTestType(dto);
    }

    @PostMapping("update-test-type/{id}")
    public ResultDto<TestTypeDto> update(@PathVariable Long id, @Valid @RequestBody TestTypeDto dto) {
